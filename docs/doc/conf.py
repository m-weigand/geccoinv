...
# built documents.
sys.path = ['../../', ] + sys.path
import setup as psetup
del(sys.path[0])

# The short X.Y version.
version = psetup.version_short
# The full version, including alpha/beta/rc tags.
release = psetup.version_long
...
latex_documents = [
    (
        'index',
        'DebyeDecomposition.tex', u'Cole-Cole Decomposition Documentation',
...
man_pages = [
    ('index', 'debyedecomposition', u'DebyeDecomposition Documentation',
     [u'Maximilian Weigand'], 1)
]
...
texinfo_documents = [
    (
        'index',
        'DebyeDecomposition', u'DebyeDecomposition Documentation',
        u'Maximilian Weigand',
        'DebyeDecomposition', 'One line description of project.',
        'Miscellaneous'
    ),
]
